...
Original file is located at
    https://colab.research.google.com/drive/1wP6XtZv4V7zYXaCmws7QR5ZLKXeGL7Kz
"""
...
def second_measurement(state, error_rate = 0.005):
...
#our code eliminates transmission errors such as heat, transmission, etc